...
- [**Validator**](/architecture/val)
  - Metis-SDK relies on a system of multiple validators with Proof of Staked (PoS) consensus that can support short block time and lower fees. The most bonded validators in staking will have the opportunity to produce blocks.
